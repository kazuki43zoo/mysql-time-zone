package com.example.mariadbjdbcdriver;
...
@SpringBootTest
@Testcontainers
class MariadbJdbcDriverApplicationWithTimeZoneParameterTests {
  ...
  static void setup(DynamicPropertyRegistry registry) {
    registry.add("spring.datasource.url", () -> mysql.getJdbcUrl() + "?sessionVariables=time_zone='${user.timezone}'");
  }
